...
class ApiServicePrayerUserDesk {
  final String baseUrl;

  ApiServicePrayerUserDesk()
      : baseUrl = dotenv.env['BASE_URL'] ??
      (throw Exception('BASE_URL is not defined in .env'));

  Future<List<Prayer>> getUserPrayers(int columnId) async {
    final response =
  ...
  Future<void> deleteUserPrayer(int prayerId) async {
  ...
  Future<Prayer> addUserPrayer(int columnId, Prayer prayer) async {
