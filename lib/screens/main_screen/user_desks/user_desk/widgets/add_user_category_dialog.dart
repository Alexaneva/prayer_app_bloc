...
class AddUserCategoryDialog extends StatelessWidget {
  const AddUserCategoryDialog({super.key});
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: isButtonEnabled
                ...
                context.read<UserDeskBloc>().add(UserDeskEvent.addCategory(newCategory));
                Navigator.of(context).pop();
              }
                  : null,
